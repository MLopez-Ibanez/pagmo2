...
class PAGMO_DLL_PUBLIC linear_value_function : public value_function //Mahdi: The value function is protected, why we have public here?
{
public:
...
class PAGMO_DLL_PUBLIC poly_value_function : public value_function //Mahdi: The value function is protected, why we have public here?
{
private:
std::vector <double> weights;
...
public:
    ...
    poly_value_function(std::vector<double> w)
        : value_function(w)
    {
      static const size_t npos = -1;
    	...
    	std::cout << "\nEnter: ";
    	std::cin >> str;
    	if(str == "") {std::cout<<"No function is defined\n";}
