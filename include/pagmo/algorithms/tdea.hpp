...
#ifndef PAGMO_ALGORITHMS_TDEA_HPP
#define PAGMO_ALGORITHMS_TDEA_HPP
...
namespace pagmo
{
/// Territory defining evlogutionary algorithm
/**

 * See:  Karahan, İ., & Koksalan, M. (2010). A territory defining multiobjective evolutionary algorithms and preference
 incorporation. IEEE Transactions on Evolutionary Computation, 14(4), 636-664.
 */
class PAGMO_DLL_PUBLIC tdea
{
public:
     ...
     * <tt>std::vector</tt> is a tdea::log_line_type containing: Gen, Fevals, ideal_point
     * as described in tdea::set_verbosity
     * @return an <tt>std::vector</tt> of tdea::log_line_type containing the logged values Gen, Fevals,
     * ideal_point
     */
...
PAGMO_S11N_ALGORITHM_EXPORT_KEY(pagmo::tdea)
